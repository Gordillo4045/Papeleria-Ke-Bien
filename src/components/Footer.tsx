...
export default function Footer() {
    return (
        <div className="grid grid-rows-2 md:grid-rows-none md:grid-flow-col rounded-b-xl max-w-7xl mx-auto">
            ...
            <div className="rounded-b-xl col-span-2 md:pt-4">
                <div className="flex items-center justify-center place-content-center md:place-content-start self-center gap-3 ">
                    {/* <a href="https://www.facebook.com/people/Papeleria-Ke-bien/61553994592502/" target="_blank">
                        <FaFacebookSquare size={"2rem"} color={"blue"} />
                    </a> */}
                    <a href="https://www.facebook.com/share/18tF7HWn5c/" target="_blank">
                        <FaFacebookSquare size={"2rem"} color={"blue"} />
                    </a>
                    <a href="https://wa.me/6613503857 " target="_blank">
                        <FaWhatsappSquare size={"2rem"} color={"green"} />
                    </a>
                    <a href="mailto:papeleriakebien@gmail.com" target="_blank">
